      ...
      <div class="flex flex-col items-center justify-between mt-6 md:flex-row">
        <div>
          <nuxt-link to="/" class="text-xl font-bold">
            <svg viewBox="0 0 559.5 178.3" class="fill-current h-12 bg-gray-white">
              <defs>
                <style>
                  .cls-1 {
                    fill: #efd82e;
        ...
        <div class="flex mt-4 md:m-0">
          <div class="-mx-4">
            <nuxt-link to="/about" class="px-4 text-sm">About</nuxt-link>
            <nuxt-link to="/blog" class="px-4 text-sm">Blog</nuxt-link>
            <nuxt-link to="/products" class="px-4 text-sm">Products</nuxt-link>
            <nuxt-link to="/contact" class="px-4 text-sm">Contact</nuxt-link>
          </div>
        </div>
      </div>
    </div>
