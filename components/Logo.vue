  ...
  <svg viewBox="0 0 559.5 178.3" class="fill-current h-20">
    ...
    <g id="Layer_2" data-name="Layer 2">
      <g id="Layer_1-2" data-name="Layer 1">
        ...
        />
        <circle class="circle cls-2" cx="145" cy="82.3" r="28" />
        <path
          class="cls-1"
...
export default {
  mounted() {
    gsap.fromTo(".cls-1", { opacity: 0 }, { opacity: 1, delay: 4, duration: 3, ease: "power.3" });
    gsap.fromTo(".cls-2", { opacity: 0 }, { opacity: 1, delay: 3, duration: 1, ease: "power.2" });
  },
};
</script>
